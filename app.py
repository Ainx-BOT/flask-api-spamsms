      ...
      def get(self):
          ...
          try:
             ...
             if "phoneVerificationId" in req:
                ...
                die+=1
             return {"result":{"terkirim":done,"gagal":die,"total_spam":done+die,"layanan":["mapclub","jagreward","matahari","olx","icq","myfave","harvest","danacita","bukuwarung","payfazz"]},"developer":"Fahmidevs"}
          except Exception as e:
              return {"Message":e,"result":None}
api.add_resource(spam,"/api/spamsms")
